// app/appointments/upcoming/page.tsx
import AppointmentList from "../../../components/appointments/AppointmentList";

export const metadata = { title: "Upcoming Appointments" };
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        <div className="relative mb-6">
          ...
          <div className="relative bg-white/90 backdrop-blur-sm border border-cyan-100 rounded-3xl px-6 py-6 shadow">
            ...
            <p className="text-cyan-800/70">All scheduled future visits.</p>
          </div>
        </div>
        <AppointmentList endpoint="/api/appointments?filter=upcoming" />
      </div>
    </div>
  );
}
